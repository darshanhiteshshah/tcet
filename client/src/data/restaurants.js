export const mockRestaurantsData = [
    {
        ...
        dishes: [
            { id: 'p1', name: 'Pani Puri', description: 'Crispy shells filled with spiced potatoes, chickpeas, and tangy tamarind water.', price: 150, imageUrl: 'https://images.pexels.com/photos/12318206/pexels-photo-12318206.jpeg',tags: ['snack', 'street food'] },
            { id: 'p2', name: 'Pav Bhaji', description: 'A flavorful mash of mixed vegetables served with soft, buttered bread rolls.', price: 250, imageUrl: 'https://images.unsplash.com/photo-1626132647523-66f5bf380027?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cGF2JTIwYmhhaml8ZW58MHx8MHx8fDA%3D' ,tags: ['snack', 'street food'] },
            { id: 'p3', name: 'Dahi Batata Puri', description: 'A delightful chaat with puris, potatoes, yogurt, and sweet and spicy chutneys.', price: 180, imageUrl: 'https://cdn.apartmenttherapy.info/image/upload/f_auto,q_auto:eco,c_fill,g_auto,w_1220,h_915/k%2FPhoto%2FSeries%2F2021-08-a-call-to-chaat%2FCall-to-Chaat_Dahi-Batata-Puri%2F2021-07-28_ATK-3659', tags: ['snack', 'street food'] },
            { id: 'p4', name: 'Panki Chatni', description: 'Thin rice pancakes steamed in banana leaves, served with chutney.', price: 170, imageUrl: 'https://assets3.thrillist.com/v1/image/2943946/1584x1056/crop;webp=auto;jpeg_quality=60;progressive.jpg', tags: ['snack', 'street food'] },
            ...
            { id: 'p6', name: 'Satpadi Roti with Gatta Nu Shaak', description: 'Seven-layered flatbread served with gram flour dumplings in a yogurt-based curry.', price: 280, imageUrl: 'https://images.pexels.com/photos/28579050/pexels-photo-28579050.jpeg',  tags: ['main course', 'vegetarian'] }
        ]
    },
    {
        id: '2',
        ...
        dishes: [
            { id: 'b1', name: 'Masala Dosa', description: 'A thin, crispy crepe made from fermented rice and lentil batter, filled with spiced potatoes.', price: 220, imageUrl: 'https://www.vegrecipesofindia.com/wp-content/uploads/2021/06/masala-dosa-recipe-2.jpg' ,tags: ['breakfast', 'vegetarian'] },
            ...
            { id: 'b3', name: 'Ghee Roast Dosa', description: 'A cone-shaped dosa roasted to perfection with clarified butter (ghee).', price: 250, imageUrl: 'https://images.unsplash.com/photo-1694849789325-914b71ab4075?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8ZG9zYXxlbnwwfHwwfHx8MA%3D%3D', tags: ['breakfast', 'vegetarian'] },
            { id: 'b4', name: 'Rava Kichadi', description: 'A savory South Indian breakfast dish made from semolina, vegetables, and spices.', price: 190, imageUrl: 'https://images.unsplash.com/photo-1630409351211-d62ab2d24da4?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8a2hpY2hkaXxlbnwwfHwwfHx8MA%3D%3D' ,tags: ['breakfast', 'vegetarian'] },
            { id: 'b5', name: 'Medu Vada', description: 'Crispy, savory doughnuts made from black gram lentils, served with sambar and chutney.', price: 160, imageUrl: 'https://images.unsplash.com/photo-1730191843435-073792ba22bc?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8dmFkYXxlbnwwfHwwfHx8MA%3D%3D' ,tags: ['snack', 'vegetarian'] },
            { id: 'b6', name: 'Appam with Coconut Milk', description: 'Lacy, soft-centered rice pancakes served with sweet, aromatic coconut milk.', price: 200, imageUrl: 'https://media.istockphoto.com/id/701198310/photo/appam-palappam-with-mutton-stew-kerala-easter-breakfast.jpg?s=1024x1024&w=is&k=20&c=QytOu8lh42O7GJY1CCxU2unTdvPRhyQ__47ZYjOWiI8=' ,tags: ['breakfast', 'vegetarian'] }
        ]
    },
    {
        id: '3',
        ...
        dishes: [
            { id: 's1', name: 'Dal Baati Churma', description: 'A traditional Rajasthani dish of hard wheat rolls, lentils, and sweetened cereal.', price: 450, imageUrl: 'https://media.istockphoto.com/id/1402853466/photo/dal-bati-rajasthani-traditional-vegetarian-food-plat-in-rural-india.jpg?s=1024x1024&w=is&k=20&c=AI_MneA5KdS9V9C6zvfjZ2v68KMr5BBXXLivz-eNcNc=', tags: ['main course', 'vegetarian'] },
            { id: 's2', name: 'Gujarati Thali', description: 'A grand platter featuring a variety of vegetarian dishes from Gujarat.', price: 550, imageUrl: 'https://images.unsplash.com/photo-1680993032090-1ef7ea9b51e5?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Z3VqYXJhdGklMjB0aGFsaXxlbnwwfHwwfHx8MA%3D%3D',   tags: ['main course', 'vegetarian'] },
            { id: 's3', name: 'Paneer Makhani', description: 'Soft paneer cubes simmered in a rich and creamy tomato-based gravy.', price: 350, imageUrl: 'https://www.indianhealthyrecipes.com/wp-content/uploads/2021/05/paneer-makhani-recipe.jpg' ,tags: ['main course', 'vegetarian'] },
            { id: 's4', name: 'Khandvi', description: 'Soft, melt-in-your-mouth rolls made from gram flour and yogurt.', price: 210, imageUrl: 'https://images.unsplash.com/photo-1588076186114-a3898e30530d?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8a2hhbmR2aXxlbnwwfHwwfHx8MA%3D%3D', tags: ['snack', 'vegetarian'] },
            ...
            { id: 's6', name: 'Gatte ki Sabzi', description: 'Gram flour dumplings cooked in a spicy and tangy yogurt-based curry.', price: 320, imageUrl: 'https://media.istockphoto.com/id/1513582138/photo/rajasthani-gatta-curry-or-besan-ke-gatte-ki-sabzi-gatte-are-gram-flour-roundels-or-chickpea.jpg?s=1024x1024&w=is&k=20&c=2LHlPBGXFLeygwX5edGxeHRbGlsIGsrIMAeCE1JlYnw=', tags: ['main course', 'vegetarian'] }
        ]
    },
    {
        id: '4',
        ...
        dishes: [
            { id: 'bb1', name: 'Samosa Soup', description: 'A tangy and spicy soup with crushed samosas.', price: 320, imageUrl: 'https://plus.unsplash.com/premium_photo-1695297516676-04a259917c03?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8c2Ftb3NhfGVufDB8fDB8fHww',tags: ['soup', 'spicy', 'snack'] },
            { id: 'bb2', name: 'Khow Suey', description: 'A one-bowl meal of noodles and vegetables in a coconut milk broth.', price: 480, imageUrl: 'https://images.pexels.com/photos/31745183/pexels-photo-31745183.jpeg' ,tags: ['noodles', 'coconut', 'vegetarian'] },
            { id: 'bb3', name: 'Tea Leaf Salad', description: 'A refreshing salad made with fermented tea leaves, nuts, and seeds.', price: 410, imageUrl: 'https://plus.unsplash.com/premium_photo-1690489323642-6e057faf3c7d?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8c2FsYWR8ZW58MHx8MHx8fDA%3D', tags: ['salad', 'healthy', 'fermented'] },
            { id: 'bb4', name: 'Tohu Mash with Paratha', description: 'Burmese-style scrambled tofu served with flaky flatbread.', price: 430, imageUrl: 'https://images.pexels.com/photos/6327133/pexels-photo-6327133.jpeg', tags: ['tofu', 'paratha', 'breakfast'] },
    ...
    },
    {
        ...
        dishes: [
            { id: 'i1', name: 'Dahi Ke Kebab', description: 'Soft, melt-in-the-mouth kebabs made from hung curd and spices.', price: 380, imageUrl: 'https://www.indianhealthyrecipes.com/wp-content/uploads/2022/03/dahi-kabab-recipe.jpg' ,   tags: ['kebab', 'vegetarian', 'snack'] },
            { id: 'i2', name: 'Dal Haveli', description: 'Their signature slow-cooked black lentils, rich and creamy.', price: 450, imageUrl: 'https://media.istockphoto.com/id/855902314/photo/delicious-spicy-lentil-soup.jpg?s=612x612&w=0&k=20&c=efgW0CNE37ZkBCb7usWtVKgDoy2OFLpTQzmJjxPJFgQ=', tags: ['dal', 'lentils', 'creamy'] },
            { id: 'i3', name: 'Waterchestnut & Corn Tikki', description: 'Crispy tikkis made with waterchestnut and corn.', price: 360, imageUrl: 'https://media.istockphoto.com/id/2029197201/photo/millet-fast-food-closeup.webp?a=1&b=1&s=612x612&w=0&k=20&c=R1YaTh2g-BERlXBO6J-boaDKWtEiWkL7IIxqvNXDjJY=' , tags: ['tikki', 'crispy', 'snack'] },
            { id: 'i4', name: 'Mushroom Galouti', description: 'A vegetarian version of the famous Lucknowi kebab, made with mushrooms.', price: 420, imageUrl: 'https://media.istockphoto.com/id/1437951082/photo/mushroom-pickle.webp?a=1&b=1&s=612x612&w=0&k=20&c=eiYXe3byRZSbyEc9uco-F0F9vlGUedb-iSQces-Y7yg=', tags: ['kebab', 'mushroom', 'vegetarian'] },
            { id: 'i5', name: 'Phirni', description: 'A classic slow-cooked Indian sweet pudding made with ground rice, milk and sugar.', price: 280, imageUrl: 'https://media.istockphoto.com/id/1453999382/photo/jhangore-ki-kheer.webp?a=1&b=1&s=612x612&w=0&k=20&c=ZKfcvqfbRZKAAtIaG8dacTEUdzjNJ7crRKgAUBCzyPo=', tags: ['dessert', 'pudding', 'sweet'] },
            { id: 'i6', name: 'Ghewar with Rabri', description: 'A disc-shaped sweet cake made with flour, soaked in syrup and topped with rabri.', price: 350, imageUrl: 'https://media.istockphoto.com/id/1412258930/photo/ghevar-sweet.jpg?s=612x612&w=0&k=20&c=kiqsOBtWCfrrwXEGczA-yD9C0gy3wynBaopQi36N0h4=', tags: ['dessert', 'sweet', 'rabri'] }
        ]
    },
    {
        id: '6',
        ...
        dishes: [
            ...
            { id: 'ml4', name: 'Dahi Bada', description: 'A reimagined dahi bada with aeration and light textures.', price: 425, imageUrl: 'https://www.indianhealthyrecipes.com/wp-content/uploads/2022/03/dahi-vada-recipe.jpg' , tags: ['snack', 'dahi', 'bada'] },
            { id: 'ml5', name: 'Khandvi with Mango Chutney', description: 'Delicate gram flour rolls paired with a sweet and tangy mango chutney.', price: 450, imageUrl: 'https://media.istockphoto.com/id/1824026139/photo/gujarati-khandvi-or-patuli-snack.jpg?s=612x612&w=0&k=20&c=NlsZXRiomUibUd_VsvOW074hDZQcAeta9TQkjfZFlYU=',   tags: ['snack', 'khandvi', 'mango'] },
